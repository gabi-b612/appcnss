...
<header class="fixed w-full top-0 bg-white shadow-md z-50">
    ...
    <nav class="p-4 flex justify-between items-center gap-10">
        <a href="{{route('entreprise.dashboard')}}">
            <div class="flex items-center space-x-4 ">
                <p class="text-gray-800 ml-0 hover:text-my-green font-extrabold size-3">Entreprise</p>
            </div>
        </a>
        <div class="flex space-x-5 items-center ">
            <a href="{{route('entreprise.immatriculation.approuver')}}" class="text-gray-800 ml-0 hover:text-my-green font-semibold">Mes Employeurs</a>
            <a href="{{route('immatriculation.create')}}" class="text-gray-800 ml-0 hover:text-my-green font-semibold">Demande d'immatriculation</a>
