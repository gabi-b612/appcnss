...
@section('content')
    <div class="container mx-auto mt-32 px-4 py-8">
        <h1 class="text-2xl font-bold text-black-blue">Immatriculations Approuvées</h1>
        ...
        @if($immatriculations->isEmpty())
            <p class="mt-4 text-gray-600">Aucun travailleurs immatriculer</p>
        @else
            <div class="mt-6">
                <table class="min-w-full bg-white border-collapse">
                    <thead>
                    <tr class="bg-black-blue text-white">
                        <th class="py-2 px-4 border-b">Numéro d'Immatriculation</th>
                        <th class="py-2 px-4 border-b">Nom du Travailleur</th>
