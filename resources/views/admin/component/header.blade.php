...
<header class="fixed w-full top-0 bg-white shadow-md z-50">
    ...
    <nav class="p-4 flex justify-between items-center gap-10">
        ...
        <div class="flex space-x-5 items-center ">
            ...
            <a href="{{route('admin.affiliations.accepter')}}" class="text-gray-800 ml-0 hover:text-my-green font-semibold">Les demande d'affiliation</a>
            <a href="{{route('admin.affiliations.accepter')}}" class="text-gray-800 ml-0 hover:text-my-green font-semibold">Les demande d'immatriculation</a>
            <a href="{{route('admin.affiliations.accepter')}}" class="text-gray-800 ml-0 hover:text-my-green font-semibold">Les Cotisations</a>
        </div>
